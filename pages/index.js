...
export default function Home() {
  ...
  const genres = [
    ...
    { id: 28, name: 'Ação', icon: 'fas fa-fist-raised' },
    { id: 35, name: 'Comédia', icon: 'fas fa-laugh' },
    { id: 18, name: 'Drama', icon: 'fas fa-theater-masks' },
    { id: 27, name: 'Terror', icon: 'fas fa-ghost' },
    { id: 878, name: 'Ficção', icon: 'fas fa-rocket' },
    { id: 10749, name: 'Romance', icon: 'fas fa-heart' },
    { id: 16, name: 'Animação', icon: 'fas fa-palette' },
  ]
  ...
  const loadAllContent = async () => {
    ...
    try {
      ...
      // Set hero content (primeiro item de trending)
  ...
  const ContentRow = ({ title, items, icon, showProgress = false }) => {
      ...
      <div className="content-row-container">
        ...
        <div className="content-row-wrapper">
          ...
          <div className="content-row-scroll" ref={scrollRef}>
            {items.map(item => (
              <ContentCard key={getItemKey(item)} item={item} showProgress={showProgress} />
            ))}
          </div>
      ...
      case 'movies':
        return (
          <>
            ...
            <GenreFilter />
            <ContentRow title="Lançamentos" items={releases.filter(i => i.media_type === 'movie')} />
            <ContentRow title="Populares" items={recommendations.filter(i => i.media_type === 'movie')} />
          </>
        )
      case 'series':
        return (
          <>
            ...
            <GenreFilter />
            <ContentRow title="No Ar" items={releases.filter(i => i.media_type === 'tv')} />
            <ContentRow title="Populares" items={recommendations.filter(i => i.media_type === 'tv')} />
          </>
        )
      case 'mylist':
        return (
