      ...
      <Head>
        ...
        <style>{`
          *{margin:0;padding:0;box-sizing:border-box;-webkit-tap-highlight-color:transparent}
          ...
          /* Barra inferior com Liquid Glass */
          .bottom-nav {
            --c-glass: #bbbbbc;
            --c-light: #fff;
            --c-dark: #000;
            ...
            backdrop-filter: blur(20px) url(#bottomNavLiquid) saturate(var(--saturation));
            ...
            transition: transform 0.3s ease, opacity 0.3s ease, background-color 400ms cubic-bezier(1, 0.0, 0.4, 1), box-shadow 400ms cubic-bezier(1, 0.0, 0.4, 1);
          }
