      ...
      <Head>
        ...
        <style>{`
          *{margin:0;padding:0;box-sizing:border-box;-webkit-tap-highlight-color:transparent}
          ...
          .bottom-nav{position:fixed;bottom:clamp(16px,3vw,24px);left:50%;transform:translateX(-50%);z-index:1000;background:transparent;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-radius:50px;height:clamp(56px,8vw,72px);display:flex;justify-content:space-around;align-items:center;padding:clamp(24px,5vw,40px);width:fit-content;max-width:95vw}
