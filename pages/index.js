...
export const LoadingScreen = ({ onComplete }) => {
  ...
  useEffect(() => { if (closing) { const t = setTimeout(() => { setMounted(false); onComplete() }, 700); return () => clearTimeout(t) } }, [closing, onComplete])
...
export const FavoriteItem = ({ item, onRemove, onClick }) => {
  ...
  const episodeCount = item.number_of_episodes || item.episodes
  const showEpisodeInfo = isTV && episodeCount
  return (
    <div className="favorite-item" onClick={() => onClick?.(item)}>
      ...
      <div className="favorite-content">
        ...
        {showEpisodeInfo && <p className="favorite-episodes">{episodeCount} Episódios</p>}
        ...
        <Head>
          ...
          <style>{`
            *{margin:0;padding:0;box-sizing:border-box;-webkit-tap-highlight-color:transparent}
            ...
            .landing-enter-btn{display:inline-flex;align-items:center;justify-content:center;background:#ffffff;color:#000000;border:none;font-size:clamp(16px,2.5vw,18px);font-weight:700;padding:clamp(12px,2vw,16px) clamp(32px,5vw,48px);border-radius:clamp(24px,4vw,32px);cursor:pointer;margin-top:clamp(24px,4vw,36px);transition:transform 0.2s cubic-bezier(0.4, 0, 0.2, 1);will-change:transform}
            ...
            .featured-btn{width:clamp(40px,6vw,48px);height:clamp(40px,6vw,48px);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:clamp(18px,2.5vw,20px);transition:transform 0.2s cubic-bezier(0.4, 0, 0.2, 1);will-change:transform}
      ...
      <Head>
        ...
        <style>{`
          *{margin:0;padding:0;box-sizing:border-box;-webkit-tap-highlight-color:transparent}
          ...
          .loading-overlay{position:fixed;inset:0;z-index:9999;display:flex;align-items:center;justify-content:center;background:#101010;transition:opacity 0.7s cubic-bezier(0.4, 0, 0.2, 1);will-change:opacity}
          ...
          .section{margin-top:clamp(16px,3vw,24px);padding:0}
          .section-title{font-size:clamp(14px,2.9vw,22px);font-weight:700;color:#ffffff;margin-left:clamp(16px,2.6vw,22px);margin-right:clamp(16px,2.6vw,22px);margin-bottom:clamp(8px,1.5vw,12px)}

          .horizontal-scroll{display:flex;overflow-x:auto;gap:clamp(8px,1.3vw,12px);padding-left:clamp(16px,2.6vw,22px);padding-right:clamp(16px,2.6vw,22px);-webkit-overflow-scrolling:touch;scrollbar-width:none}
          ...
          .vertical-scroll{display:flex;overflow-x:auto;gap:clamp(8px,1.3vw,12px);padding-left:clamp(16px,2.6vw,22px);padding-right:clamp(16px,2.6vw,22px);-webkit-overflow-scrolling:touch;scrollbar-width:none}
          ...
          .featured-card{border-radius:clamp(14px,2vw,20px);overflow:hidden;margin:0 clamp(16px,2.6vw,22px);background:#1B1B1B}
          .featured-poster{width:100%;aspect-ratio:16/9;overflow:hidden}
          .featured-img{width:100%;height:100%;object-fit:cover}
          .featured-details{padding:clamp(16px,3vw,24px);background:#1B1B1B;display:flex;flex-direction:column;gap:clamp(12px,2vw,16px)}
          .featured-text{flex:1}
          ...
          .nav-item{display:flex;flex-direction:column;align-items:center;gap:clamp(2px,0.5vw,4px);color:#5B5B5B;font-size:clamp(9px,1.5vw,12px);font-weight:600;transition:color 0.2s cubic-bezier(0.4, 0, 0.2, 1);padding:clamp(4px,1vw,8px)}
          .nav-item i{font-size:clamp(16px,3vw,24px)}
          .nav-item.active{color:#ffffff}

          .filters-container{display:flex;gap:clamp(10px,2vw,23px);margin-left:clamp(16px,2.6vw,22px);margin-right:clamp(16px,2.6vw,22px);margin-top:clamp(20px,3vw,28px);overflow-x:auto;scrollbar-width:none;padding-right:clamp(16px,2.6vw,22px)}
          .filters-container::-webkit-scrollbar{display:none}
          .filter-btn{height:clamp(36px,6vw,56px);padding:0 clamp(16px,3vw,32px);border-radius:clamp(18px,3vw,28px);font-size:clamp(13px,2vw,18px);font-weight:700;white-space:nowrap;transition:all 0.25s cubic-bezier(0.4, 0, 0.2, 1);will-change:background,color}
          .filter-btn.active{background:#ffffff;color:#000000}
          .filter-btn:not(.active){background:transparent;color:#A0A0A0}

          .favorites-list{padding:0 clamp(16px,2.6vw,22px);margin-top:clamp(16px,3vw,24px)}
          .favorite-item{display:flex;padding:clamp(12px,2vw,18px) 0;position:relative;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.05);gap:clamp(12px,2vw,18px)}
          ...
          .favorite-remove{position:absolute;top:clamp(12px,2vw,18px);right:0;color:#D0D0D0;font-size:clamp(22px,3.5vw,34px);width:clamp(22px,3.5vw,34px);height:clamp(22px,3.5vw,34px);display:flex;align-items:center;justify-content:center;flex-shrink:0;z-index:1}
          ...
          .search-results-list{padding:0 clamp(16px,2.6vw,22px);margin-top:clamp(20px,3.5vw,30px)}
          ...
          .social-btn{width:clamp(52px,8vw,72px);height:clamp(52px,8vw,72px);border-radius:50%;background:#ffffff;display:flex;align-items:center;justify-content:center;font-size:clamp(24px,4vw,34px);color:#000000;transition:transform 0.2s cubic-bezier(0.4, 0, 0.2, 1);will-change:transform}
          ...
          .profile-top-btn{width:40px;height:40px;border-radius:50%;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);background:rgba(128,128,128,0.3);border:1px solid rgba(255,255,255,0.12);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;transition:transform 0.2s cubic-bezier(0.4, 0, 0.2, 1),background 0.2s cubic-bezier(0.4, 0, 0.2, 1);will-change:transform}
          .profile-top-btn:active{transform:scale(0.95)}
          .profile-save-btn{background:#fff;color:#000;font-size:16px;font-weight:700;padding:8px 20px;border-radius:20px;transition:transform 0.2s cubic-bezier(0.4, 0, 0.2, 1);will-change:transform}
          ...
          .profile-favorites-title{font-size:clamp(14px,2.9vw,22px);font-weight:700;color:#fff;padding:0 clamp(16px,2.6vw,22px);margin:0 0 clamp(8px,1.5vw,12px)}
          ...
          .logout-cancel-btn{flex:1;padding:12px;border-radius:12px;background:transparent;border:1px solid rgba(255,255,255,0.2);color:#ffffff;font-size:14px;font-weight:600;cursor:pointer;transition:background 0.2s cubic-bezier(0.4, 0, 0.2, 1)}
          .logout-cancel-btn:active{background:rgba(255,255,255,0.05)}
          .logout-confirm-btn{flex:1;padding:12px;border-radius:12px;background:#E04E4E;color:#ffffff;font-size:14px;font-weight:600;cursor:pointer;transition:background 0.2s cubic-bezier(0.4, 0, 0.2, 1)}
          .logout-confirm-btn:active{background:#c0392b}
